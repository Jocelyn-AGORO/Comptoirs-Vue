  ...
  <main>
    <div>
      ...
      <form @submit.prevent="ajouteProduit">
        <div>
          <input id="libelle" v-model="data.formulaireProduit.nom" placeholder="Nom du produit" />
        </div>
        <div>
          <input id="description" v-model="data.formulaireProduit.prixUntaire" placeholder="Prix unitaire" />
        </div>
